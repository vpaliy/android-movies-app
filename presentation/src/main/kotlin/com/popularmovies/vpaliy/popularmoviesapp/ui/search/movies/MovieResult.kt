...
import com.popularmovies.vpaliy.popularmoviesapp.ui.more.MoreMediaAdapter
...
class MovieResult : SearchResult<Movie>() {
  ...
  private val adapter by lazy {  MoreMediaAdapter(context, {}) }
