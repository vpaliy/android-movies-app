...
public class MovieSQLHelper extends SQLiteOpenHelper{
    ...
    interface Tables {
        ...
        String MOVIE_JOIN_FAVORITES=INNER_JOIN+FAVORITE+ON+MOVIES+DOT+Movies._ID+"="+FAVORITE+DOT+FavoriteMedia.COLLECTION_MEDIA_ID;
        String MOVIE_JOIN_TOP_RATED=INNER_JOIN+TOP_RATED+ON+MOVIES+DOT+Movies._ID+"="+TOP_RATED+DOT+TopRatedMedia.COLLECTION_MEDIA_ID;
        String MOVIE_JOIN_LATEST=INNER_JOIN+LATEST+ON+MOVIES+DOT+Movies._ID+"="+LATEST+DOT+LatestMedia.COLLECTION_MEDIA_ID;
        String MOVIE_JOIN_NOW_PLAYING=INNER_JOIN+NOW_PLAYING+ON+MOVIES+DOT+Movies._ID+"="+NOW_PLAYING+DOT+NowPlayingMedia.COLLECTION_MEDIA_ID;
        String MOVIE_JOIN_UPCOMING=INNER_JOIN+UPCOMING+ON+MOVIES+DOT+Movies._ID+"="+UPCOMING+DOT+UpcomingMedia.COLLECTION_MEDIA_ID;
        String MOVIE_JOIN_POPULAR=INNER_JOIN+POPULAR+ON+MOVIES+DOT+Movies._ID+"="+POPULAR+DOT+PopularMedia.COLLECTION_MEDIA_ID;
        String MOVIE_JOIN_RECOMMENDED=INNER_JOIN+RECOMMENDED+ON+MOVIES+DOT+Movies._ID+"="+RECOMMENDED+DOT+RecommendedMedia.COLLECTION_MEDIA_ID;
