...
import com.popularmovies.vpaliy.domain.toResult
...
@Singleton
class PeopleRepository @Inject constructor(private val service:SearchService,
                                           private val mapper: Mapper<Actor, ActorModel>) :Repository,SearchRepository<Actor>{
